...
const About: React.FC<AboutContextProps> = ({authUser, currentUser}) => {
  return (
    ...
    <Card.Body className='text-left'>
      ...
      <p className='gap-4 justify-content-between d-flex align-items-center'><strong className='d-flex align-items-center'><FaBirthdayIcon className="me-2" />Birthday:</strong> June 26, 1980</p>
      <p className='gap-4 justify-content-between d-flex align-items-center'><strong className='d-flex align-items-center'><FaAddressIcon className="me-2" />Address:</strong> 2239 Hop Camp Road</p>
